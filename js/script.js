...
stringInput.addEventListener("focus", function(){
...
document.getElementById("submit4").addEventListener("click", function(){
  ...
  var lengthResult = stringLength(string.value);

  // Use the variable to set the output form field value & log the result to the console
  lengthInput.value = lengthResult;

  // Get the input value from the form & log the value
  console.log(stringInput.value + " is " + lengthResult + " letters long, baby!");
